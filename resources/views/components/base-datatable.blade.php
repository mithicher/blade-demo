{{--
	/* 
		Sample Example 
		Todo: Search only current table for now
			  Use custom logic in controller for relation table search
	*/
	<x-base-datatable
		:headings="['#', 'Name', 'Email', 'Created at', 'Action']"
		:values="[
			[
				'key' => 'id', 
				'type' => 'data'
	...
	/* Dependency
	// partials/tailwindPaginationAlpine.blade.php
	*/
--}}
		...
		{{--<tfoot>
			<tr>
				<td colspan="5" class="pt-4">
					{{ $data->links('partials.tailwindPaginationAlpinejs') }}
				</td>
			</tr>	
		</tfoot>--}}
	</table>
